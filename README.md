...
- Zoom images and web content, fit images to a window, and customize SVG colors or the background of an open document, which follows light/dark appearance changes.
